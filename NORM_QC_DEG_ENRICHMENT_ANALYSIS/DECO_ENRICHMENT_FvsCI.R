...
my_enrichment(deco_data, P.Value=0.05, Profile = c("Majority", "Complete"), FA_label="enrichment_FERTILE_vs_COMBINED_INFERTILITY_DECO", cutoff=1,organism="human",FC=1.5)
