...
# Loading DEG data
deg_data <-  readxl::read_excel("SIMPLE_INFERTILITY_vs_COMBINED_INFERTILITY.xlsx")
...
my_enrichment(filtered_deg_data, P.Value=0.05, FA_label="enrichment_SIMPLE_INFERTILITY_vs_COMBINED_INFERTILITY_DEG&DECO", cutoff=1,organism="human",FC=1.5)
